...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open(r'C:\Users\ankit\OneDrive\Documents\Desktop\VS CODE\image processing_face\StudentDetails.csv', 'a+') as csvFile:
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv(r'C:\Users\ankit\OneDrive\Documents\Desktop\VS CODE\image processing_face\StudentDetails.csv')
                cam = cv2.VideoCapture(0)
